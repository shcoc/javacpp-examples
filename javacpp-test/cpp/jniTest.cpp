...
static void JavaCPP_test_auto_Add_deallocate(void *p) { delete (test::Add*)p; }
static void JavaCPP_test_auto_Add_deallocateArray(void* p) { delete[] (test::Add*)p; }
...
JNIEXPORT jint JNICALL Java_test_auto_Add_add(JNIEnv* env, jobject obj, jint arg0, jint arg1) {
    test::Add* ptr = (test::Add*)jlong_to_ptr(env->GetLongField(obj, JavaCPP_addressFID));
    if (ptr == NULL) {
...
JNIEXPORT void JNICALL Java_test_auto_Add_allocate(JNIEnv* env, jobject obj) {
    jthrowable exc = NULL;
    try {
        test::Add* rptr = new test::Add();
        jlong rcapacity = 1;
        JavaCPP_initPointer(env, obj, rptr, rcapacity, rptr, &JavaCPP_test_auto_Add_deallocate);
    } catch (...) {
        exc = JavaCPP_handleException(env, 8);
    }
...
JNIEXPORT void JNICALL Java_test_auto_Add_allocateArray(JNIEnv* env, jobject obj, jlong arg0) {
    jthrowable exc = NULL;
    try {
        test::Add* rptr = new test::Add[arg0];
        jlong rcapacity = arg0;
        JavaCPP_initPointer(env, obj, rptr, rcapacity, rptr, &JavaCPP_test_auto_Add_deallocateArray);
    } catch (...) {
        exc = JavaCPP_handleException(env, 8);
    }
...
JNIEXPORT jint JNICALL Java_test_global_Test_max(JNIEnv* env, jclass cls, jint arg0, jint arg1) {
    jint rarg = 0;
    jthrowable exc = NULL;
    try {
        int rval = test::max(arg0, arg1);
        rarg = (jint)rval;
    } catch (...) {
        exc = JavaCPP_handleException(env, 8);
    }
